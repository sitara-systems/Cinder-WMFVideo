...
class MediaType {
   ...
   protected:
    BOOL IsValid() { return m_pType != NULL; }
   ...
   public:
    ...
    virtual ~MediaType() { SAFE_RELEASE(m_pType); }
    ...
    // address-of operator
    IMFMediaType** operator&() { return &m_pType; }

    // coerce to underlying pointer type.
    operator IMFMediaType*() { return m_pType; }
    ...
    HRESULT GetMajorType(GUID* pGuid) { return GetMediaType()->GetMajorType(pGuid); }

    // Specifies whether the media data is compressed
    HRESULT IsCompressedFormat(BOOL* pbCompressed) { return GetMediaType()->IsCompressedFormat(pbCompressed); }

    // Compares two media types and determines whether they are identical.
    HRESULT IsEqual(IMFMediaType* pType, DWORD* pdwFlags) { return GetMediaType()->IsEqual(pType, pdwFlags); }
    ...
    HRESULT SetMajorType(GUID guid) { return GetMediaType()->SetGUID(MF_MT_MAJOR_TYPE, guid); }
    ...
    HRESULT SetSubType(GUID guid) { return GetMediaType()->SetGUID(MF_MT_SUBTYPE, guid); }
    ...
    HRESULT SetSampleSize(UINT32 nSize) { return GetMediaType()->SetUINT32(MF_MT_SAMPLE_SIZE, nSize); }
    ...
    BOOL FixedSizeSamples() { return (BOOL)MFGetAttributeUINT32(GetMediaType(), MF_MT_FIXED_SIZE_SAMPLES, FALSE); }

    UINT32 SampleSize() { return MFGetAttributeUINT32(GetMediaType(), MF_MT_SAMPLE_SIZE, 0); }
};
...
class VideoType : public MediaType {
   ...
   public:
    ...
    HRESULT SetDefaultStride(LONG nStride) { return GetMediaType()->SetUINT32(MF_MT_DEFAULT_STRIDE, (UINT32)nStride); }
    ...
    HRESULT SetDataBitErrorRate(UINT32 rate) { return GetMediaType()->SetUINT32(MF_MT_AVG_BIT_ERROR_RATE, rate); }
    ...
    HRESULT SetAvgerageBitRate(UINT32 rate) { return GetMediaType()->SetUINT32(MF_MT_AVG_BITRATE, rate); }
    ...
    HRESULT GetCustomVideoPrimaries(MT_CUSTOM_VIDEO_PRIMARIES* pPrimaries) {
        ...
        return GetMediaType()->GetBlob(MF_MT_CUSTOM_VIDEO_PRIMARIES, (UINT8*)pPrimaries,
                                       sizeof(MT_CUSTOM_VIDEO_PRIMARIES), NULL);
    }

    // Sets custom color primaries.
    HRESULT SetCustomVideoPrimaries(const MT_CUSTOM_VIDEO_PRIMARIES& primary) {
        return GetMediaType()->SetBlob(MF_MT_CUSTOM_VIDEO_PRIMARIES, (const UINT8*)&primary,
    ...
    MFRatio GetPixelAspectRatio()  // Defaults to 1:1 (square pixels)
    {
        ...
        hr = MFGetAttributeRatio(GetMediaType(), MF_MT_PIXEL_ASPECT_RATIO, (UINT32*)&PAR.Numerator,
...
class AudioType : public MediaType {
   ...
   public:
    ...
    HRESULT SetBitsPerSample(UINT32 nBits) { return GetMediaType()->SetUINT32(MF_MT_AUDIO_BITS_PER_SAMPLE, nBits); }
    ...
    HRESULT SetBlockAlignment(UINT32 nBytes) { return GetMediaType()->SetUINT32(MF_MT_AUDIO_BLOCK_ALIGNMENT, nBytes); }
    ...
    HRESULT SetChannelMask(UINT32 nMask) { return GetMediaType()->SetUINT32(MF_MT_AUDIO_CHANNEL_MASK, nMask); }
    ...
    HRESULT SetNumChannels(UINT32 nChannels) { return GetMediaType()->SetUINT32(MF_MT_AUDIO_NUM_CHANNELS, nChannels); }
    ...
    UINT32 BitsPerSample() { return MFGetAttributeUINT32(GetMediaType(), MF_MT_AUDIO_BITS_PER_SAMPLE, 0); }

    UINT32 GetBlockAlignment() { return MFGetAttributeUINT32(GetMediaType(), MF_MT_AUDIO_BLOCK_ALIGNMENT, 0); }

    double FloatSamplesPerSecond() {
        return MFGetAttributeDouble(GetMediaType(), MF_MT_AUDIO_FLOAT_SAMPLES_PER_SECOND, 0.0);
    }

    UINT32 NumChannels() { return MFGetAttributeUINT32(GetMediaType(), MF_MT_AUDIO_NUM_CHANNELS, 0); }

    UINT32 SamplesPerSecond() { return MFGetAttributeUINT32(GetMediaType(), MF_MT_AUDIO_SAMPLES_PER_SECOND, 0); }
};
...
class MPEGVideoType : public VideoType {
   ...
   public:
    ...
    HRESULT SetStartTimeCode(UINT32 nTime) { return GetMediaType()->SetUINT32(MF_MT_MPEG_START_TIME_CODE, nTime); }
    ...
    HRESULT SetMPEG2Flags(UINT32 nFlags) { return GetMediaType()->SetUINT32(MF_MT_MPEG2_FLAGS, nFlags); }
    ...
    HRESULT SetMPEG2Level(UINT32 nLevel) { return GetMediaType()->SetUINT32(MF_MT_MPEG2_LEVEL, nLevel); }
    ...
    HRESULT SetMPEG2Profile(UINT32 nProfile) { return GetMediaType()->SetUINT32(MF_MT_MPEG2_PROFILE, nProfile); }
};
